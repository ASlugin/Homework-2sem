...
namespace SkipList.Tests
{
    public class Tests
    {
        ...
        public void IndexOfShallReturnCorrectIndex()
        {
            ...
            list.Add(4);
            list.Add(29);
            Assert.AreEqual(list.IndexOf(-20), 0);
            Assert.AreEqual(list.IndexOf(4), 1);
            Assert.AreEqual(list.IndexOf(11), 2);
            Assert.AreEqual(list.IndexOf(19), 3);
            Assert.AreEqual(list.IndexOf(29), 4);
            Assert.AreEqual(list.IndexOf(100), 5);

            Assert.AreEqual(list.IndexOf(99), -1);
        }
        ...
        public void ElementByIndexShallReturnCorrectElement()
        {
            ...
            Assert.AreEqual(list[1], 12);
            Assert.AreEqual(list[2], 19);
        }
